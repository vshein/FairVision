#!/bin/bash
# ViT-B + Fair Identity Scaling (FIS) experiment on the AMD task with SLO fundus images.
# Usage:  ./scripts/train_amd_vit_fis.sh
# Override the dataset location if needed:  DATASET_DIR=/path/to/FairVision ./scripts/train_amd_vit_fis.sh
